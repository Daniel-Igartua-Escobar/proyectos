...
// devolver al cliente y la función nos da un array con la combinación de 
// monedas mínimas que debemos usar para conseguirlo.
...
// que te permita conocer las monedas que tienes disponible para crear el array 
// con la devolución, ya que debes usar siempre el menor número de monedas 
// posible. ¡Suerte 👩‍💻👨‍💻!.
...
function getCoins(change) {
  ...
  coins.forEach(coin => {
    result.unshift(Math.trunc(change/coin));
    change = change%coin;
  })
